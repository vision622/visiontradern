...
exports.AccountsMt5StandardFinancialBviLightIcon = void 0;
const React = __importStar(require("react"));
const react_1 = require("react");
const types_1 = require("../../types");
const AccountsMt5StandardFinancialBviLightIcon = ({ iconSize = 'md', title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 48 32', ...types_1.sizes[iconSize], role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    title ? React.createElement("title", { id: titleId }, title) : null,
    React.createElement("path", { fill: '#0364B9', d: 'M33 7H18a4.5 4.5 0 0 0-4.5 4.5v13.125h24V11.5A4.5 4.5 0 0 0 33 7' }),
    React.createElement("path", { fill: '#0A559E', d: 'M18 7a4.5 4.5 0 0 0-4.5 4.5v.13l22.436-3.54A4.48 4.48 0 0 0 33 7zM37.5 11.5c0-1.128-.415-2.16-1.101-2.95l-2.947 16.075H37.5z' }),
    ...
    React.createElement("path", { fill: '#0A559E', d: 'M7 1a4.5 4.5 0 0 0-4.5 4.5v.13l22.436-3.54A4.48 4.48 0 0 0 22 1zM26.5 5.5c0-1.128-.415-2.16-1.101-2.95l-2.947 16.075H26.5z' }),
    ...
    React.createElement("path", { fill: '#4BB4B3', d: 'M44.384 20h-9.768c-.296 0-.58.117-.789.325s-.327.491-.327.786v7.778c0 .295.118.577.327.786.21.208.493.325.79.325h9.767c.296 0 .58-.117.789-.325s.327-.491.327-.786V21.11c0-.295-.118-.577-.327-.786a1.12 1.12 0 0 0-.79-.325' }),
...
exports.AccountsMt5StandardFinancialBviLightIcon = AccountsMt5StandardFinancialBviLightIcon;
const ForwardRef = (0, react_1.forwardRef)(exports.AccountsMt5StandardFinancialBviLightIcon);
