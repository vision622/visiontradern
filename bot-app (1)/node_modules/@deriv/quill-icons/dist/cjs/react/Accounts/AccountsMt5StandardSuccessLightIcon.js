...
const AccountsMt5StandardSuccessLightIcon = ({ iconSize = 'md', title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 48 48', ...types_1.sizes[iconSize], role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    ...
    React.createElement("path", { fill: '#4BB4B3', d: 'M40 25.95a4 4 0 1 1-8 0 4 4 0 0 1 8 0' }),
    React.createElement("path", { fill: '#fff', fillRule: 'evenodd', d: 'M37.573 24.524a.25.25 0 1 1 .354.354l-2.5 2.5a.25.25 0 0 1-.354 0l-1-1a.25.25 0 1 1 .354-.354l.823.823z', clipRule: 'evenodd' })));
exports.AccountsMt5StandardSuccessLightIcon = AccountsMt5StandardSuccessLightIcon;
const ForwardRef = (0, react_1.forwardRef)(exports.AccountsMt5StandardSuccessLightIcon);
