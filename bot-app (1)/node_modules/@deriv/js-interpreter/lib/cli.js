...
"use strict";
/* provided dependency */ var acorn = __webpack_require__(/*! ./original-repo/acorn.js */ "./original-repo/acorn.js");
/**
 * @license
...
/* harmony import */ var _original_repo_interpreter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../original-repo/interpreter */ "./original-repo/interpreter.js");
/* harmony import */ var _original_repo_interpreter__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_original_repo_interpreter__WEBPACK_IMPORTED_MODULE_3__);





const argv = minimist__WEBPACK_IMPORTED_MODULE_2___default()(process.argv.slice(2));

const lineReader = readline__WEBPACK_IMPORTED_MODULE_1___default().createInterface({
  input: argv._.length
    ? fs__WEBPACK_IMPORTED_MODULE_0___default().createReadStream(argv._[0])
    : process.stdin,
});
...
lineReader.on('close', () => new _original_repo_interpreter__WEBPACK_IMPORTED_MODULE_3__.Interpreter(code, initFunc).run());
